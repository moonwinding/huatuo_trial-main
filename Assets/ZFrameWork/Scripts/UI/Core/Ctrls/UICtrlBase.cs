...
public class UICtrlBase
{
	...
	protected ComponentSetterFullData  fullData;
	...
	public virtual void OnPost(System.Action<StepResult, int> pCb)//异步逻辑的处理（例如网络通信层的处理）返回true 界面加载成功 返回false 界面打开失败
	{
		pCb.Invoke(StepResult.Next,1);
	}
